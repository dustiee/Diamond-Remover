...
internal static class LogTools
{
  ...
  {
    DiamondRemover.Log!.LogInfo(FormatMessage(obj, caller, callerPath));
  }
  ...
  internal static void Verbose(
      ...
      [CallerFilePath] string callerPath = "")
  {
    if (DiamondRemover.Verbose)
    {
      DiamondRemover.Log!.LogDebug(FormatMessage(obj, caller, callerPath));
    }
  }
  ...
  internal static void Warn(
      ...
      [CallerFilePath] string callerPath = "")
  {
    DiamondRemover.Log!.LogWarning(FormatMessage(obj, caller, callerPath));
  }
  ...
  internal static void Error(
      ...
      [CallerFilePath] string callerPath = "")
  {
    DiamondRemover.Log!.LogError(FormatMessage(obj, caller, callerPath));
  }
  ...
  internal static void Fatal(
      ...
      [CallerFilePath] string callerPath = "")
  {
    DiamondRemover.Log!.LogFatal(FormatMessage(obj, caller, callerPath));
  }
